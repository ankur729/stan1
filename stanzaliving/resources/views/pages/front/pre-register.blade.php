...
<form method="post" action="" enctype="multipart/form-data" onSubmit="preregistervalidate()">
<div class="container">
	<div class="section-1">
				...
				<div class="form-line">
					...
					<div class="col-md-25  padding-right-10px  left">
						...
						<div class="input-div">
							...
							<option value="London House" <?php if(@$_POST['choose_house']=='London House'){echo "selected='selected'";}?>>London House</option>
							<option value="New York House" <?php if(@$_POST['choose_house']=='New York House'){echo "selected='selected'";}?>>New York House</option>
							<option value="Los Angeles" <?php if(@$_POST['choose_house']=='Los Angeles'){echo "selected='selected'";}?>>Los Angeles </option>
							</select>
					...
					<div class="col-md-25  padding-right-10px  left">
						...
						<div class="input-div">
							...
							<option value="Single Occupancy" <?php if(@$_POST['type_of_occupancy']=='Single Occupancy'){echo "selected='selected'";}?>>Single Occupancy</option>
							<option value="Twin Sharing" <?php if(@$_POST['type_of_occupancy']=='Twin Sharing'){echo "selected='selected'";}?>>Twin Sharing</option>
							</select>
			...
			<div class="row">
				<div class="form-line">
					...
					<div class="col-md-25  padding-right-10px  left">
						...
						<div class="input-div">
						<select name="state" class="input-box">
						<option value="">select state</option>
						<?php foreach($state_arr as $star){?>
						<option value="<?php echo $star;?>" <?php if($star==@$_POST['state']){echo "selected='selected'";}?>><?php echo $star;?></option>
						<?php }?>
						</select>
					...
					<div class="col-md-25 left">
						...
						<div class="input-div">
							<input type="text" name="city" class="input-box" placeholder="City" value="<?php echo @$_POST['city'];?>">
