       ...
       <div class="box-body">
          <div class="col-xs-10">
            <div class="form-group">
             <img id="img_view" src=" {{ URL::to('images/student/'.$student->s_image)  }}" alt="your image" style="width:100px;height:100px"><br>
...
<!-- 
  ...
  <div class="box-body">
    ...
    <br>{!!     Form::radio('s_gender', "1", ['class' => 'form-control']) !!} Male<br>{!!     Form::radio('s_gender', $student->s_gender,  ['class' => 'form-control']) !!} Female
...
<!--              <div class="box-body">
 ...
 <select class="form-control nation" name="s_nationality">
       <option value="{{$student->s_nationality}}"></option>
       @foreach($countries as $c)
       <?php $s=""; ?>
          @if($student->s_nationality==$c->id)
          <?php $s="selected"; ?>
          @endif
