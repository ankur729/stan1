...
+                   <input type="hidden" name="_token" value="{{ csrf_token() }}">  
							<div class="log-input">
								<div class="log-input-left">
								   <input id="email" name="email" type="text" class="user" value="Yourname" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Email address:';}"/>
								</div>
							...
							<div class="log-input">
								<div class="log-input-left">
								   <input id="password" name="password" type="password" class="lock" value="password" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Email address:';}"/>
								</div>
								<span class="checkbox2">
									 <label class="checkbox"><input type="checkbox" name="checkbox" checked=""><i> </i></label>
								</span>
