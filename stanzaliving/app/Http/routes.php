...
Route::get('/pre-register', function () {	
    return view('pages.front.pre-register');
});

Route::get('/profile/{id?}', 'Front\ProfileController@index');
Route::get('/student-complaint/{id?}', 'Front\ProfileController@studentcomplaint');
Route::get('/food-menu/{id?}', 'Front\ProfileController@foodmenu');
...
Route::get('/test1/{name?}','TestController@testMethod');
...
Route::group(['middleware' => 'auth'], function () {
	...
	Route::get('admin/dashboard', 'AdminLoginController@show_admin_auth_view');
